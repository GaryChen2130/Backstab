...
public class nija_left : MonoBehaviour
{
    ...
    //    Debug.Log("" + (begin_pos - nija_l.transform.position.x));
        if(begin_pos - nija_l.transform.position.x <= new_pos && back == false)
        {
    //        Debug.Log("Go");
    ...
    //        Debug.Log("Limit");
        ...
        if (begin_pos - nija_l.transform.position.x > new_pos && back == true)
        {
    //        Debug.Log("Back");
