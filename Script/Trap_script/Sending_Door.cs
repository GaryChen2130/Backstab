...
public class Sending_Door : MonoBehaviour
{
    public GameObject sending;
    static public bool isColl;
    ...
    {
        if (collision.gameObject.name.Contains("character") && Sending_Door1.isColl == false)
        {
            isColl = true;
